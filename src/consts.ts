...
export const SIMULATORS_CINEMATICA = [
  {
    name: 'Simulador de Movimiento Rectilíneo Uniforme (MRU)',
    description: 'Simula el movimiento de un objeto en línea recta con velocidad constante.',
    url: '/simulators/cinematica/mru',
    image: '/images/simulator-mru.png',
    buttonText: 'Iniciar simulación',
  },
  {
    name: 'Simulador de Movimiento Rectilíneo Uniformemente Acelerado (MRUA)',
    description: 'Simula el movimiento de un objeto en línea recta con aceleración constante.',
    url: '/simulators/cinematica/mrua',
    image: '/images/simulator-mrua.png',
    buttonText: 'Iniciar simulación',
  },
  {
  ...
  {
    name: 'Simulador de Tiro Parabólico',
    description: 'Simula el movimiento de un objeto lanzado en una trayectoria parabólica.',
    url: '/simulators/cinematica/tiro-parabolico',
    image: '/images/simulator-tiro-parabolico.png',
    buttonText: 'Iniciar simulación',
  },
  {
    name: 'Simulador de Tiro Vertical',
    description: 'Simula el movimiento de un objeto lanzado verticalmente.',
    url: '/simulators/cinematica/tiro-vertical',
    image: '/images/simulator-tiro-vertical.png',
    buttonText: 'Iniciar simulación',
  },
]